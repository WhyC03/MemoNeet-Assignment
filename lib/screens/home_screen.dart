...
// import 'package:flutter/material.dart';
// import 'package:get/get.dart';
// import 'package:memoneet_assignment/controllers/product_controller.dart';
// import 'package:memoneet_assignment/screens/product_detail_screen.dart';
// import 'package:memoneet_assignment/theme.dart';
// import 'package:memoneet_assignment/widgets/banner_carousel.dart';
// import 'package:memoneet_assignment/widgets/product_card.dart';
          ...
          children: [
            ...
            Obx(
              () => Row(
                ...
                children: List.generate(categories.length, (index) {
                  final isSelected =
                      productController.selectedExamCategory.value ==
                      categories[index];
                  return GestureDetector(
                    onTap:
                        () => productController.selectExamCategory(
                          categories[index],
                        ),
                    child: Container(
                      margin: EdgeInsets.symmetric(horizontal: 6),
                      ...
                      () => Row(
                        children:
                            chipLabels.map((label) {
                              final isSelected =
                                  productController.selectedTag.value == label;
                              return Padding(
                                padding: const EdgeInsets.all(5.0),
                                child: GestureDetector(
                                  onTap:
                                      () => productController.selectTag(label),
                                  child: Chip(
                                    label: Text(
                                      label,
                                      style: TextStyle(
                  ...
                  Obx(
                    () => SizedBox(
                      child: ListView.builder(
                        ...
                        physics: NeverScrollableScrollPhysics(),
                        itemCount:
                            (productController.filteredProducts.length / 2)
                                .ceil(),
                        itemBuilder: (context, index) {
                          int first = index * 2;
                          int second = first + 1;
